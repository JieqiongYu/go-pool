...
func main() {
	...
	// Decalre an array of 5 integers
	// Note: If we do not inialize a value for the array, they will default to the
	// zero value of the type. In the case of integers, we epxect the zero value to be 0.
	var myArray [5]int
	fmt.Printf("Contents of myArray: %v\n\n", myArray)

	// Arrays are poassed as value to functions, meaning a copy of the array is passed
