...
func main() {
	...
	// We use a ticker to specifier the interval to update the values
	// on the scoreboard
...
// is more than 500 years old) to compute
func pi(n int) float64 {
	...
	// We notifiy that the computation is done over the channel
...
// This function servers as our virtual scoreboard to show the current
