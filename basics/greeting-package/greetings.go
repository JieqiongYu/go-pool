...
// Since it's unexported it will only be visible to functions that are within the greeting_package
func printGreetingsUnexported() {
	fmt.Println("I'm printing a message from the printGreetingUnexported() function!")
}