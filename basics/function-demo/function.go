...
// Thus, it is considered a void function.
var y = 4
...
func oddOrEven(x int) {
	...
	// The variable y is visible inside this function, because it exists in the global scope.
	// Therefore, y is a global variable.
	if y%2 == 0 {
...
// An example of a function that takes 2 input parameters and returns an output of  type int
...
// main is a niladic function because it dosen't accept any arguments
func main() {
	var numberToCheck = 7
	oddOrEven(numberToCheck)

	fmt.Println("The sum of 100 and 8: ", sumTowNumbers(100, 8))
